  ...
  return (
      <div className='App list-group-item justify-content-center align-items-center mx-auto' style={{"width":"400px","backgroundColor":"white","marginTop":"15px"}}>
        ...
        <div className='card-body'>
          <h5 className='card text-white bg-dark mb3'>Add your Task</h5>
          <span className='card-text'>
            ...
            <button className='btn btn-outline-primary mx-2 mb-2' style={{'borderRadius':'50px','front-weight':'bold'}} onClick={addTodoHandler}>Add Task</button>
          </span>
